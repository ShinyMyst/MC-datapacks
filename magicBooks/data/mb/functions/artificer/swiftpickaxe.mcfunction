...
execute as @s[scores={mb.isCasting=1..}] run give @p golden_pickaxe{display:{Name:'{"text":"Swift Pickaxe","color":"gold"}'},RepairCost:40,Enchantments:[{id:"minecraft:efficiency",lvl:5s}]} 1
